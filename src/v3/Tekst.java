...
public class Tekst {
	...
	double rotation, scale, tekstwidth, tekstheight, size;
	...
	public void draw(Graphics2D g) {
		...
		GradientPaint paint = new GradientPaint((int) position.getX(),(int) position.getY(), Color.RED,	(int) (position.getX() + tekstwidth),(int) (position.getY() + tekstheight), Color.BLUE);
		g.setPaint(paint);
		...
		center = new Point2D.Double(position.getX()+(tekstwidth/2),position.getY()+tekstheight/2);
		g.draw(shape);
